  ...
  return (
    <div className="p-3 h-full">
      <div className="grid lg:mx-[10rem] sm:grid-cols-2 place-items-center">
        ...
        <img src="../../data/aboutusImg/ourVision.webp" alt="alt" />
      </div>
      ...
      <main>
        <div className="grid grid-cols-2  sm:grid-cols-2 lg:grid-cols-5 lg:mx-10">
          <Watches title="HYBRID" img="%PUBLIC_URL%/aboutusImg/hybrid.webp ">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. A, amet?
          </Watches>
          <Watches
            title="AUTOMATIC"
            img="%PUBLIC_URL%/aboutusImg/automatic.webp"
          >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. A, amet?
          </Watches>
          <Watches
            title="STAINLESS"
            img="%PUBLIC_URL%/aboutusImg/stainless.webp"
          >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. A, amet?
          </Watches>
          <Watches
            title="GOLD DIAL"
            img="%PUBLIC_URL%/aboutusImg/golddial.webp"
          >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. A, amet?
          </Watches>
          <Watches
            title="WORKWEAR"
            img="%PUBLIC_URL%/aboutusImg/workwear.webp"
...
function Watches({ title, img, children, className }) {
  return (
    <div className={`text-center p-2 ${className}`}>
      <img src={img} alt="alt" className="m-auto p-5 hover:scale-125" />
