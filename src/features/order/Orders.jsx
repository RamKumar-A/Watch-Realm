  ...
  return (
    <div className="p-8 space-y-6">
      ...
      {orders?.length === 0 ? (
        ...
        orders?.map((order) => (
          <div className="grid gap-6 place-content-center" key={order?._id}>
            <div className="bg-secondary-default p-6 rounded-lg shadow grid lg:grid-cols-[1fr_2fr] gap-4 place-content-center justify-items-center">
              {/* Order Summary */}
              <div>
